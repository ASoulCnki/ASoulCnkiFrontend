<template>
  <div class="body-content h-full m-0 p-0 w-full bg-gray-100 dark:bg-gray-600">
    <div class="dark:bg-gray-600 h-full w-full overflow-hidden lg:mx-auto xl:w-5/6">
          ...
          <div class="text-header">
            <ul>
              ...
              <li style="vertical-align: -0.12rem;">
                <button class="button px-5 h-15 report" id="copy" :disabled="!reportable">
